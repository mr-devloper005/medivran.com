...
const desks = [
  { icon: FileText, title: 'Release intake', body: 'Send press releases, source notes, corrections, and publication questions.' },
  { icon: Megaphone, title: 'Distribution partnerships', body: 'Discuss syndication, newsroom collaborations, campaign coverage, and media placements.' },
  { icon: Mail, title: 'Account support', body: 'Reach the team for login, publishing, or archive visibility help.' },
]
      ...
      <main className="bg-[var(--slot4-page-bg)] text-[var(--slot4-page-text)]">
        <section className="bg-white">
          <div className="mx-auto max-w-[var(--editable-container)] px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
            ...
            <h1 className="editorial-serif mt-4 max-w-4xl text-5xl font-black leading-tight sm:text-7xl">{pagesContent.contact.title}</h1>
        ...
        <section className="mx-auto grid max-w-[var(--editable-container)] overflow-hidden rounded-md bg-white shadow-[0_24px_70px_rgba(39,49,44,.08)] lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="border-b border-black/10 bg-[var(--slot4-dark-bg)] text-white lg:border-b-0 lg:border-r lg:border-black/10">
